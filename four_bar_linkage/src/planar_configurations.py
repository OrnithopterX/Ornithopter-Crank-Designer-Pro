...
def duelCrankOppositeAnim(radius_input, radius_output, conrod, x_input, x_output, y_output):
	fcrank = lambda x: -x
...
def duelCrankCommonAnim(radius_input, radius_output, conrod, x_input, x_output, y_output, ang_offset):
	fcrank = lambda x: x + ang_offset
	x_input += radius_input
	output = PlanarAnimation(radius_input, radius_output, conrod, x_input, x_output, y_output, fcrank)
	return output.animate()
